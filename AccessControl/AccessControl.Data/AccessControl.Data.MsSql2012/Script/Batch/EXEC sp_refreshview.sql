...
EXEC sp_refreshview @viewname = '[Owner].[Entity.BranchTier]';
...
EXEC sp_refreshview @viewname = '[Stock.Article].[Entity.Split]';
EXEC sp_refreshview @viewname = '[Stock.Article].[Entity.Group]';
EXEC sp_refreshview @viewname = '[Stock.Article].[Entity.Bond]';

EXEC sp_refreshview @viewname = '[Stock].[Entity.Article]';
EXEC sp_refreshview @viewname = '[Stock].[Entity.Depot]';
EXEC sp_refreshview @viewname = '[Stock].[Entity.Pricelist]';
EXEC sp_refreshview @viewname = '[Stock].[Entity.PricelistItem]';
EXEC sp_refreshview @viewname = '[Stock].[Entity.Outcome]';
EXEC sp_refreshview @viewname = '[Stock].[Entity.OutcomeItem]';
EXEC sp_refreshview @viewname = '[Stock].[Entity.Order]';
EXEC sp_refreshview @viewname = '[Stock].[Entity.OrderItem]';
*/